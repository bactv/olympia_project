...
<div class="type-question-form">
    ...
    <?= $form->field($model, 'name')->label(Yii::t('cms', 'Name Type'))->textInput(['maxlength' => 255]) ?>

    <?= $form->field($model, 'code')->label(Yii::t('cms', 'Type Question Code'))->textInput(['maxlength' => 255]) ?>
    ...
    <?= $form->field($model, 'status')->checkbox(['label' => ''])->label(Yii::t('cms', 'Status')) ?>
