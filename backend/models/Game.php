...
class Game extends \common\models\GameBase
{
    public static function choosePlayer($type_game)
    {
        ...
        if ($type_game == Yii::$app->params['type_game'][2]) {
        ...
        } else if ($type_game == Yii::$app->params['type_game'][3]) {
        ...
        } else if ($type_game == Yii::$app->params['type_game'][4]) {
        ...
        } else if ($type_game == Yii::$app->params['type_game'][1]) {
            $temp = $query->all();
